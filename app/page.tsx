...
export default function Home() {
  return (
    <div className="min-h-screen">
      <a
        href="#main"
        className="sr-only focus:not-sr-only focus:fixed focus:left-6 focus:top-6 focus:z-[60] focus:rounded-lg focus:bg-white focus:px-4 focus:py-3 focus:text-sm focus:font-semibold focus:text-zinc-900 focus:shadow-lg"
      >
        본문으로 건너뛰기
      </a>
      ...
      <main id="main" className="bg-zinc-50">
        <Hero />
        <SocialProof />
        <Problem />
        <Solution />
